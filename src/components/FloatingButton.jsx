  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute -top-10 right-0 bg-gray-800 text-white text-sm py-1 px-2 
      ...
      {/* Chat Window */}
      {isChatOpen && (
        <div className="fixed bottom-4 right-4 w-80 bg-white rounded-lg shadow-2xl z-50">
      ...
      {/* Score Window */}
      {isScoreOpen && (
        <div className="fixed bottom-24 right-4 w-80 bg-white rounded-lg shadow-2xl z-50">
          <div className="flex items-center justify-between p-4 bg-blue-600 text-white rounded-t-lg">
            <h3 className="font-semibold">Resume Score</h3>
            <button onClick={() => setIsScoreOpen(false)}>
              <FiX className="w-5 h-5" />
            </button>
          </div>
          <div className="p-4">
